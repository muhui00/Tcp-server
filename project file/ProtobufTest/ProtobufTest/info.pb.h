...
PROTOBUF_NAMESPACE_OPEN
template<> ::b::Person* Arena::CreateMaybeMessage<::b::Person>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace b {
...
class Person :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:b.Person) */ {
 public:
  Person();
  virtual ~Person();
  ...
  // @@protoc_insertion_point(class_scope:b.Person)
 private:
  class HasBitSetters;
...
inline const std::string& Person::address() const {
  // @@protoc_insertion_point(field_get:b.Person.address)
...
inline void Person::set_address(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:b.Person.address)
}
inline void Person::set_address(std::string&& value) {
  
  address_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:b.Person.address)
}
inline void Person::set_address(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:b.Person.address)
}
inline void Person::set_address(const void* value, size_t size) {
  
  address_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:b.Person.address)
}
inline std::string* Person::mutable_address() {
  
  // @@protoc_insertion_point(field_mutable:b.Person.address)
...
inline std::string* Person::release_address() {
  // @@protoc_insertion_point(field_release:b.Person.address)
...
inline void Person::set_allocated_address(std::string* address) {
  ...
  // @@protoc_insertion_point(field_set_allocated:b.Person.address)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 Person::number() const {
  // @@protoc_insertion_point(field_get:b.Person.number)
  return number_;
}
inline void Person::set_number(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  number_ = value;
  // @@protoc_insertion_point(field_set:b.Person.number)
}
