...
extern PROTOBUF_INTERNAL_EXPORT_info_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Person_info_2eproto;
namespace a {
...
static void InitDefaultsscc_info_Person_person_2eproto() {
  ...
  {
    void* ptr = &::a::_Person_default_instance_;
    new (ptr) ::a::Person();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::a::Person::InitAsDefaultInstance();
}
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_person_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::a::Person, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::a::Person, id_),
  PROTOBUF_FIELD_OFFSET(::a::Person, name_),
  PROTOBUF_FIELD_OFFSET(::a::Person, sex_),
  PROTOBUF_FIELD_OFFSET(::a::Person, age_),
  PROTOBUF_FIELD_OFFSET(::a::Person, color_),
  PROTOBUF_FIELD_OFFSET(::a::Person, info_),
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::a::_Person_default_instance_),
};

const char descriptor_table_protodef_person_2eproto[] =
  "\n\014person.proto\022\001a\032\ninfo.proto\"n\n\006Person\022"
  "\n\n\002id\030\001 \001(\005\022\014\n\004name\030\002 \003(\014\022\013\n\003sex\030\003 \001(\t\022\013"
  "\n\003age\030\004 \001(\005\022\027\n\005color\030\005 \001(\0162\010.a.Color\022\027\n\004"
  "info\030\006 \001(\0132\t.b.Person*%\n\005Color\022\007\n\003Red\020\000\022"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_person_2eproto = {
  &descriptor_table_person_2eproto_initialized, descriptor_table_protodef_person_2eproto, "person.proto", 188,
...
void Person::InitAsDefaultInstance() {
  ::a::_Person_default_instance_._instance.get_mutable()->info_ = const_cast< ::b::Person*>(
      ::b::Person::internal_default_instance());
}
class Person::HasBitSetters {
 public:
  static const ::b::Person& info(const Person* msg);
};
...
Person::Person()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:a.Person)
}
Person::Person(const Person& from)
  ...
  // @@protoc_insertion_point(copy_constructor:a.Person)
}
...
Person::~Person() {
  // @@protoc_insertion_point(destructor:a.Person)
  SharedDtor();
}
...
void Person::Clear() {
// @@protoc_insertion_point(message_clear_start:a.Person)
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(mutable_sex(), ptr, ctx, "a.Person.sex");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // int32 age = 4;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 40)) {
          ...
          CHK_(ptr);
          set_color(static_cast<::a::Color>(val));
        } else goto handle_unusual;
        continue;
      // .b.Person info = 6;
      case 6:
...
#define DO_(EXPRESSION) if (!PROTOBUF_PREDICT_TRUE(EXPRESSION)) goto failure
  ::PROTOBUF_NAMESPACE_ID::uint32 tag;
  // @@protoc_insertion_point(parse_start:a.Person)
  for (;;) {
      ...
      case 5: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (40 & 0xFF)) {
          ...
          DO_((::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          set_color(static_cast< ::a::Color >(value));
        } else {
          goto handle_unusual;
        }
        break;
...
success:
  // @@protoc_insertion_point(parse_success:a.Person)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:a.Person)
  return false;
#undef DO_
}
...
void Person::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:a.Person)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:a.Person)
}

::PROTOBUF_NAMESPACE_ID::uint8* Person::InternalSerializeWithCachedSizesToArray(
    ::PROTOBUF_NAMESPACE_ID::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:a.Person)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:a.Person)
  return target;
}

size_t Person::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:a.Person)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:a.Person)
  GOOGLE_DCHECK_NE(&from, this);
  const Person* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<Person>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:a.Person)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:a.Person)
    MergeFrom(*source);
  }
}

void Person::MergeFrom(const Person& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:a.Person)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (from.has_info()) {
    mutable_info()->::b::Person::MergeFrom(from.info());
  }
  if (from.id() != 0) {
    set_id(from.id());
  }
...
// @@protoc_insertion_point(generalized_copy_from_start:a.Person)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:a.Person)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::a::Person* Arena::CreateMaybeMessage< ::a::Person >(Arena* arena) {
  return Arena::CreateInternal< ::a::Person >(arena);
}
